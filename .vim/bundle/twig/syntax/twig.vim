" Contributed:	Gabriel Gosselin <gabrielNOSPAM@evidens.ca>

if exists("b:did_syntax") | finish | endif

let templatedFileType = templatedExtensionRecognizer#guessTemplatedFiletype()
exec 'runtime! syntax/'.templatedFileType.'.vim syntax/'.templatedFileType.'_*.vim syntax/'.templatedFileType.'/*.vim'
